        ...
        >
          ...
          <motion.div variants={item} className="flex flex-wrap items-center gap-3">
            ...
            <a
              href="/cv/cv2026.pdf"
              download
              className="inline-flex items-center gap-2 rounded-md px-4 py-2.5 text-sm font-medium text-text-secondary transition-colors hover:bg-nav-hover hover:text-text-primary"
            >
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden>
